...
type Service interface {
	...
	// PUT /server/610331c94bce2ca96a757456/operation/start
	StartServer(serverId string) error
	// PUT /server/610331c94bce2ca96a757456/operation/stop
	StopServer(serverId string) error
	//// PUT /server/610331c94bce2ca96a757456/operation/restart
	//RestartServer(serverId string) error
	//// DELETE /server/610331c94bce2ca96a757456
...
func (s service) RenameOrganization(id string, name string) error {
	panic("implement me")
}
...
*/
func (s service) CreateServer(name, protocol, cipher, hash string) (*Server, error) {
...
func (s service) AttachOrganizationToServer(organizationId, serverId string) error {
...
func (s service) StartServer(serverId string) error {
...
func (s service) StopServer(serverId string) error {
...
func (s service) AddRouteToServer(serverId string, network string) error {
	err := s.StopServer(serverId)
	if err != nil {
		return err
	}
